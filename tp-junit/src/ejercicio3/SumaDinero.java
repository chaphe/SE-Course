...
public class SumaDinero {
	...
	public void sumar(SumaDinero otraSuma) throws MonedaIncompatibleException {		
		if (moneda.equalsIgnoreCase(otraSuma.moneda)) {
			throw new MonedaIncompatibleException(moneda, otraSuma.moneda);
		}
